...
# =============================================================================
# 8. plot() dispatch works (tests fix #4)
# =============================================================================
p = plot(tau_w)
stopifnot(!is.null(p))
cat("PASS 8: plot.synthdid_estimate_weighted works\n")

# =============================================================================
# 9. Event study returns correct shape (tests fix #4 S3 dispatch)
# =============================================================================
...
cat("PASS 9: event study shape and plot dispatch work\n")

# =============================================================================
# 10. Placebo SE is positive and finite
# =============================================================================
se_pl = sqrt(vcov(tau_w, method = 'placebo'))
stopifnot(is.finite(se_pl), se_pl > 0)
cat("PASS 10: placebo SE positive:", round(se_pl, 3), "\n")

# =============================================================================
# 11. Jackknife SE is positive and finite (requires N1 > 1 — passes here)
# =============================================================================
se_jk = sqrt(vcov(tau_w, method = 'jackknife'))
stopifnot(is.finite(se_jk), se_jk > 0)
cat("PASS 11: jackknife SE positive:", round(se_jk, 3), "\n")

# =============================================================================
# 12. Bootstrap SE is positive and finite
# =============================================================================
se_bt = sqrt(vcov(tau_w, method = 'bootstrap'))
stopifnot(is.finite(se_bt), se_bt > 0)
cat("PASS 12: bootstrap SE positive:", round(se_bt, 3), "\n")

# =============================================================================
# 13. DID weighted estimate is finite
# =============================================================================
tau_did_w = did_estimate_weighted(Y, N0, T0, treated.weights = treated_weights)
stopifnot(is.finite(as.numeric(tau_did_w)))
cat("PASS 13: did_estimate_weighted finite:", round(as.numeric(tau_did_w), 3), "\n")

# =============================================================================
# 14. SC weighted estimate is finite
# =============================================================================
tau_sc_w = sc_estimate_weighted(Y, N0, T0, treated.weights = treated_weights)
stopifnot(is.finite(as.numeric(tau_sc_w)))
cat("PASS 14: sc_estimate_weighted finite:", round(as.numeric(tau_sc_w), 3), "\n")
...
stopifnot(n1_eff < N1)
cat("PASS 15: N1_eff", round(n1_eff, 0), "< N1", N1, "\n")
