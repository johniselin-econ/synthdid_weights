...
2. A replication file based on Borgschult and Vogler (2020). The raw data are not available online, but an open-source version has been created by "county_dataset_creation.R"
